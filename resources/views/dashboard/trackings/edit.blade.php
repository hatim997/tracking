...
@section('title', __('Edit Tracking'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.trackings.update', $tracking->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row p-5">
                        <h3>{{ __('Edit Tracking') }}</h3>
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('serial_no') is-invalid @enderror" type="text" id="serial_no"
                                ...
                                value="{{ old('serial_no', $tracking->serial_no) }}" />
                            @error('serial_no')
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('client') is-invalid @enderror" type="text" id="client"
                                name="client" value="{{ old('client', $tracking->client) }}" required placeholder="{{ __('Enter client') }}" />
                            @error('client')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('tracking_date') is-invalid @enderror" type="date" id="tracking_date"
                                name="tracking_date" value="{{ old('tracking_date', \Carbon\Carbon::parse($tracking->tracking_date)->format('Y-m-d')) }}" required placeholder="{{ __('Enter tracking date') }}" />
                            @error('tracking_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('item_tested') is-invalid @enderror" type="text" id="item_tested"
                                name="item_tested" value="{{ old('item_tested', $tracking->item_tested) }}" required placeholder="{{ __('Enter item_tested') }}" />
                            @error('item_tested')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('technique') is-invalid @enderror" type="text" id="technique"
                                name="technique" value="{{ old('technique', $tracking->technique) }}" required placeholder="{{ __('Enter technique') }}" />
                            @error('technique')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('report') is-invalid @enderror" type="text" id="report"
                                name="report" value="{{ old('report', $tracking->report) }}" required placeholder="{{ __('Enter report') }}" />
                            @error('report')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('location') is-invalid @enderror" type="text" id="location"
                                name="location" value="{{ old('location', $tracking->location) }}" required placeholder="{{ __('Enter location') }}" />
                            @error('location')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            <label for="remarks" class="form-label">{{ __('Remarks') }}</label><span
                                class="text-danger">*</span>
                            <textarea class="form-control @error('remarks') is-invalid @enderror" name="remarks" id="remarks" cols="30" rows="10" required>{{ old('remarks', $tracking->remarks) }}</textarea>
                            @error('remarks')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Update Tracking') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
